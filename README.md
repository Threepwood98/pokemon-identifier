...
API RESTful que identifica un Pokémon a partir de una imagen usando un sistema híbrido de dos etapas: un modelo **ViT local** (Vision Transformer) como clasificador principal y **Gemini 1.5 Flash** de Google como fallback inteligente para imágenes del mundo real.
...
| `gemini_vision` | Gemini 1.5 Flash — ViT con baja confianza (~1–2s)        |
...
| `google-generativeai` | Cliente de Gemini 1.5 Flash            |
